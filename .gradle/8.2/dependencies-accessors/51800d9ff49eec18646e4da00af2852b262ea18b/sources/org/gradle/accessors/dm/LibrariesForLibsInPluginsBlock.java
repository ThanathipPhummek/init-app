...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Returns the group of libraries at insert
    ...
    public static class InsertLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at insert.koin
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class InsertKoinLibraryAccessors extends SubDependencyFactory {
        private final InsertKoinAndroidxLibraryAccessors laccForInsertKoinAndroidxLibraryAccessors = new InsertKoinAndroidxLibraryAccessors(owner);

        public InsertKoinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at insert.koin.androidx
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public InsertKoinAndroidxLibraryAccessors getAndroidx() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForInsertKoinAndroidxLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class InsertKoinAndroidxLibraryAccessors extends SubDependencyFactory {

        public InsertKoinAndroidxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("insert.koin.androidx.compose");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: koinComposeVersion (3.4.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKoinComposeVersion() { return getVersion("koinComposeVersion"); }
